...
from image_social.blueprints.admin import admin_bp
from image_social.blueprints.ajax import ajax_bp
from image_social.blueprints.auth import auth_bp
from image_social.blueprints.main import main_bp
from image_social.blueprints.user import user_bp
from image_social.extensions import bootstrap, db, login_manager, mail, dropzone, moment, whooshee, avatars, csrf
from image_social.models import Role, User, Photo, Tag, Follow, Notification, Comment, Collect, Permission
from image_social.settings import config
...
def register_commands(app):
    ...
    def forge(user, follow, photo, tag, collect, comment):
        ...
        from image_social.fakes import fake_admin, fake_comment, fake_follow, fake_photo, fake_tag, fake_user, fake_collect
